export const Data = [
    {
        id : 1,
        image : require('../../assets/pratham_photo.png'),
        title : "Pratham Joshi",
    ...
    },    
    {
        ...
        description : "I am very passionate about technology especially Web Technology.",
    },
    {
        id : 3,
        image : require('../../assets/divyaraj_photo.png'),
        title : "Divyaraj Paramar",
        sub_title : "Front-end Developer",
        description : "I Currently pursuing B.E In Information Technology, HTML,CSS and JavaScript",
    },
    {
        id : 4,
        image : require('../../assets/dev_photo.png'),
        title : "Dev Sachaniya",
