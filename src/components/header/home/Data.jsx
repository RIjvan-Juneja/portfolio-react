...
const Data = () => {
  return (
    <div className="home__data">
        <h1 className="home__title">Rijvan Juneja
        <svg
                  width="36"
                  height="36"
                  viewBox="0 0 48 48"
        ...
        <p className="home__description">I have passion for learning new things and improving my skills through practical experience</p>
